...
import { Container, FormWrap, Icon, FormContent, Form, FormInput, FormH1, FormLabel, FormButton, IconStyle, SignInBtnLink } from './SigninElements'
        ...
        <FormWrap>
          ...
          <FormContent>
            <Form action='#'>
              ...
              <SignInBtnLink type='submit'to='/patient'><IconStyle><FaDirections/></IconStyle>Continue</SignInBtnLink>
            </Form>
          </FormContent>
        </FormWrap>
      </Container>
