        ...
        <FormContent>
          <Form action="#">
            <FormControl sx={{ mx: 17, color: "#eceff1" }}>
              <RadioGroup row onChange={props.changeSignUpType} value={props.SignUpType}>
                <FormControlLabel
                  value="Doctor"
                  label="Doctor"
                  control={
            ...
            <FormH1>
              Welcome to our website Pharmacy .Please enter your personal information
              carefully!
            </FormH1>
            <Table>
              <tr>
              ...
              <tr>
                ...
                <td>
                  <FormLabel htmlFor="for">Type</FormLabel>
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td>
                  <FormSelect
                    ...
                    required
                  >
                    <FormOption value="day">Day</FormOption>
                    <FormOption value="night">Night</FormOption>
                  </FormSelect>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  <FormSelect
                    ...
                    required
                  >
                    {Towns.map(option=> <FormOption value={option}>{option}</FormOption>)}
